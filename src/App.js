...
import form7 from './component/forms/form7';
      ...
      <div>
        <Router>
          ...
          <div className="container">
            ...
            <Route path="/component/form1" component={form1} />
            <Route path="/component/form2" component={form2} />
            <Route path="/component/form3" component={form3} />
            <Route path="/component/form4" component={form4} />
            <Route path="/component/form5" component={form5} />
            <Route path="/component/form6" component={form6} />
            <Route path="/component/form7" component={form7} />
